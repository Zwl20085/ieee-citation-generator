...
**Expected output:** 5 numbered citations, each properly formatted, saved to `input-batch_ieee.txt`
...
**Expected output (GPT-3 paper with 14 authors):**
```
...
**Verify:**
- [x] Hyphen replaced with en-dash in page range
